...
average1 = (p1score + p2score + p3score)/3  # average using  ‘/’ operator
average2 = (p1score + p2score + p3score)//3 # average using ‘//’ operator

print('The average of all three scores is: ', average1)
print('The average of all three scores is: ', average2)
